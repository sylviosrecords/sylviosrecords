...
import {
  ...
  Music, Loader2, Search, TrendingUp, ChevronDown, ImageOff,
  X, ArrowLeft, ShoppingCart, BookOpen, Sparkles, Clock, Calendar, Heart
} from 'lucide-react';

// ── Módulos do projeto ───────────────────────────────────────────────────────
import colecoesData from './colecoes.json';
import artigosData  from './artigos.json';
import { STORE_NAME, STORE_LINK, STORE_LOGO, FAQ, LINKS } from './config';
import type { Produto, Colecao, Artigo } from './types';
import { slugify, renderMarkdown, fmt, disc } from './utils';
import { useRoute } from './hooks/useRoute';
import { useFavoritos, FavCtx } from './contexts/FavoritosContext';
import { useProdutos, useBuscaPesquisa, useProduto, useDescricao, useProdutosColecao } from './hooks/useProdutos';
